    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div
                ...
                <p><font>会员登录</font>USER LOGIN&nbsp;&nbsp;<font style="color: red;font-size: 10px">${msg
                        }</font></p>

                <div>&nbsp;</div>
                <form action="${ pageContext.request.contextPath }/ServletUserLogin"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="code_img"
                        ...
                        <div class="col-sm-offset-2 col-sm-10">
                            <div class="checkbox">
                                <label> <input type="checkbox" name="autoLogin" value="true"> 自动登录
                                    ...
                                    type="checkbox" name="checkName"> 记住用户名
                            </label>
                            </div>
                        </div>
                    </div>
