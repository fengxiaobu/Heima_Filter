...
<script>
    $(function () {
        $("#username_val").blur(function () {
            var usernaem = $(this).val();
            alert(usernaem);
            $.post("${pageContext.request.contextPath}/ServletFindByUsername", {"username": usernaem}, function (data) {
                alert(data);
                var $username = $("#username_idea");
                if (data == true) {
                    $username.html("<span style='color: green; size: 10px' >用户名可以使用!</span>");
                    //$("#submit").disabled(true);
                } else if (data == false) {
                    $username.html("<span style='color: red; size: 10px' >用户名已被占用!</span>");
...
<div class="container"
    ...
    <div class="row">
        ...
        <div class="col-md-8"
            ...
            <font>会员注册</font>USER REGISTER<font style="color: red;font-size:5px">${msg
                }</font>
            <form action="${pageContext.request.contextPath }/ServletRegister"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="username_val"
                               name="username" placeholder="请输入用户名">
                        <span id="username_idea"></span>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" name="code_img" class="form-control">

                    </div>
                    <div class="col-sm-2">
                        <img src="${pageContext.request.contextPath }/CheckImgServlet"
                             id="code_img" onclick="chageImg()"/>
                    </div>
...
<script type="text/javascript">
    function chageImg() {
        document.getElementById("code_img").src = "${ pageContext.request.contextPath }/CheckImgServlet?time="
            + new Date().getTime();
    }
</script>
</html>
